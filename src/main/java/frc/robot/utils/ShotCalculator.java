...
public class ShotCalculator {
	...
	public void calculate() {
		...
		this.shooterRps = shootingEstimator.get(shooterMps) * 1.02;
	...
	private void simulateShot() {
		...
		for (int i = 0; i < previewTrajectory.length; i++) {
			...
			double xy = new Translation3d(position).toTranslation2d()
					.minus(ballReleasePosition.getTranslation().toTranslation2d()).getNorm();
